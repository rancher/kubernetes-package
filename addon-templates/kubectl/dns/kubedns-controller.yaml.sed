...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
      - name: kubedns
        image: $GCR_IO_REGISTRY/google_containers/k8s-dns-kube-dns-amd64:1.14.5
        resources:
      ...
      - name: dnsmasq
        image: $GCR_IO_REGISTRY/google_containers/k8s-dns-dnsmasq-nanny-amd64:1.14.5
        livenessProbe:
          httpGet:
      ...
      - name: sidecar
        image: $GCR_IO_REGISTRY/google_containers/k8s-dns-sidecar-amd64:1.14.5
        livenessProbe:
          httpGet:
            path: /metrics
            port: 10054
